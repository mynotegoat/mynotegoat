...
export default function PatientsPage() {
  ...
  const followUpItems = useMemo(() => {
    return buildFollowUpItems(filteredPatients, {
      ...
      xrayClearWhen: followUpSettings.xrayClearWhen,
      mriCtClearWhen: followUpSettings.mriCtClearWhen,
      specialistClearWhen: followUpSettings.specialistClearWhen,
    ...
    followUpSettings.mriCtClearWhen,
    followUpSettings.specialistClearWhen,
    followUpSettings.xrayClearWhen,
